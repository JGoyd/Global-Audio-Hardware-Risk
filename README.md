...
**Software mitigations (iOS updates, sandboxing, blocking automatic playback) may reduce exposure but can not fully restore memory isolation guarantees of infected devices under the current hardware configuration.**
